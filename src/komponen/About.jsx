                ...
                <div className="order-1 lg:p-10 flex lg:items-center lg:max-w-[50vw] lg:-mr-32">
                    <div className="bg-slate-700/50 backdrop-blur-sm lg:rounded-3xl p-10 lg:pr-32">
                        ...
                        <h2 className="text-white text-2xl lg:text-4xl font-bold text-center mb-10">
                            {bahasa=='ind' ? 'Apa itu HZS-Studio' : 'Who are we and what we do?' }
                        </h2>
                        <p className="text-gray-200 text-sm lg:text-lg font-monos text-center">
                            {bahasa=='ind' ? (
                                <>
                                ...
                                <>
                                    HZS-Studio is a freelance studio specializing in 3D services, including modeling, texturing, and animation. With over two years of experience, HZS-Studio has handled various projects, such as low-poly modeling, sculpting, texturing, animation, and rendering. <br />

                                    HZS-Studio is committed to delivering high-quality results across a wide range of areas, including architectural visualization, interior design, character creation, game assets, 3D printing, and logo animation. In addition, HZS-Studio also offers website development services, including interactive 3D-based websites.
                                </>
                            )}
