...
export default function Porto() {
    ...
    const [filteredPorto, setFilteredPorto] = useState(portof);
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            setFilteredPorto(
                selectedFilter ? portof.filter((p) => p.filter.includes(selectedFilter)) : portof
            );
    ...
    return (
        <section className="container w-full mx-auto min-h-screen text-white font-monos flex flex-col">
            ...
            <motion.h1 
                ...
                whileTap={{ scale: 1.08 }}
                transition={{ type: "spring", stiffness: 300, damping: 10 }}
            >Check Our Latest Work</motion.h1>
